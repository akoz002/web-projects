...
class DrumPad extends React.Component {
  ...
  render() {
    ...
    return (
      React.createElement("button", { id: id, style: style,
        disabled: this.props.powerOn ? '' : 'disabled',
        className: "drum-pad",
        onMouseDown: this.pressButton,
        onMouseUp: this.releaseButton },
      React.createElement("audio", { id: this.props.keyboardKey, className: "clip",
...
React.createElement("section", { id: "drum-grid-section" },
React.createElement("div", { id: "display" },
React.createElement("p", null, playedDrumPad)),

React.createElement("div", { id: "drum-grid" },
drumBank.map((drumPad) =>
React.createElement(DrumPadContainer, { key: drumPad.key,
...
React.createElement("span", { className: "state-desc" }, ' ' + stateDesc)),

React.createElement("input", { type: "range", min: "0", max: "1", className: "range-input",
  value: value,
...
React.createElement("input", { type: "range", min: "0", max: "100", className: "range-input",
  value: value,
...
React.createElement("h1", null, "Drum Machine App"),
React.createElement("p", null, "Press keys or click on the buttons to play drum samples."),
React.createElement("p", null, "Try listening to a slow to mid tempo heavy metal or hard rock track, and keeping the beat. It's a lot of fun!"),
React.createElement("p", null, "All credit goes to the awesome\xA0",
React.createElement("a", { href: "https://www.youtube.com/watch?v=IKIDbeTGkd0", target: "_blank" }, "metal drum samples pack"), ".")),




React.createElement("main", { id: "drum-machine" },
React.createElement(PowerSwitch, { desc: "Power",
  value: powerOn,
  stateDesc: powerOn ? "ON" : "OFF" }),
React.createElement(BankSwitch, { desc: "Bank",
  value: bankIndex,
  stateDesc: drumBanks[bankIndex].bankName }),
React.createElement(VolumeSlider, { desc: "Volume",
  value: volume,
  stateDesc: volume }),
React.createElement(DrumGrid, { drumBank: drumBanks[bankIndex].bankArray,
...
ReactDOM.render(
React.createElement(ReactRedux.Provider, { store: reduxStore },
React.createElement(DrumAppContainer, { drumBanks: drumBanks })),
