...
React.createElement("button", { id: id, className: "button",
...
const ButtonGrid = () => {
  ...
  return (
    React.createElement("section", { id: "button-grid" },
    numbers.map((button) =>
    React.createElement(NumberButton, { key: button.id,
      id: button.id,
      char: button.char })),

    operators.map((button) =>
    React.createElement(OperatorButton, { key: button.id,
      id: button.id,
      char: button.char })),

    React.createElement(DecimalButton, {
      id: "decimal",
      char: "." }),
    React.createElement(EqualsButton, {
      id: "equals",
      char: "=" }),
...
React.createElement("section", { id: "display-section" },
React.createElement("p", { id: "expr" }, expr),
React.createElement("p", { id: "display" }, input)),
